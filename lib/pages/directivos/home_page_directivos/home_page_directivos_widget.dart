...
import 'home_page_directivos_model.dart';
export 'home_page_directivos_model.dart';

class HomePageDirectivosWidget extends StatefulWidget {
  const HomePageDirectivosWidget({super.key});

  @override
  State<HomePageDirectivosWidget> createState() =>
      _HomePageDirectivosWidgetState();
}

class _HomePageDirectivosWidgetState extends State<HomePageDirectivosWidget>
    with TickerProviderStateMixin {
  late HomePageDirectivosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomePageDirectivosModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'homePageDirectivos'});
