...
import 'listado_padre_preceptorias_model.dart';
export 'listado_padre_preceptorias_model.dart';

class ListadoPadrePreceptoriasWidget extends StatefulWidget {
  const ListadoPadrePreceptoriasWidget({super.key});

  @override
  State<ListadoPadrePreceptoriasWidget> createState() =>
      _ListadoPadrePreceptoriasWidgetState();
}

class _ListadoPadrePreceptoriasWidgetState
    extends State<ListadoPadrePreceptoriasWidget>
    with TickerProviderStateMixin {
  late ListadoPadrePreceptoriasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListadoPadrePreceptoriasModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'listadoPadrePreceptorias'});
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'LISTADO_PADRE_PRECEPTORIAS_Container_896');
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'LISTADO_PADRE_PRECEPTORIAS_btn-filter_ON');
                                  logFirebaseEvent(
                                ...
                                child: Padding(
                                  ...
                                  child: FutureBuilder<ApiCallResponse>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      final listViewMentorshipsPerParentResponse =
                                          snapshot.data!;
                                      ...
                                      return Builder(
                                        builder: (context) {
                                          final students = IntisanaVIIGroup
                                                  .mentorshipsPerParentCall
                                                  .student(
                                                    listViewMentorshipsPerParentResponse
                                                        .jsonBody,
                                                  )
                                                  ?.map((e) => e)
                                                  .toList()
                                          ...
                                          return RefreshIndicator(
                                            ...
                                            onRefresh: () async {
                                              logFirebaseEvent(
                                                  'LISTADO_PADRE_PRECEPTORIAS_ListView_kuqd');
                                              logFirebaseEvent(
                                              ...
                                              itemBuilder:
                                                ...
                                                return Padding(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'LISTADO_PADRE_PRECEPTORIAS_projectCard_O');
                                                      logFirebaseEvent(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          FFButtonWidget(
                                                                            onPressed:
                                                                                () async {
                                                                              logFirebaseEvent('LISTADO_PADRE_PRECEPTORIAS_FIRMAR_BTN_ON');
                                                                              logFirebaseEvent('Button_backend_call');
                                                                              _model.apiResult86m = await IntisanaVIIGroup.updateMentorshipStatusCall.call(
                                                                                id: getJsonField(
                                                                                  studentsItem,
                                                                                  r'''$.id''',
                                                                                ).toString(),
                                                                              ...
                                                                              if ((_model.apiResult86m?.succeeded ?? true)) {
