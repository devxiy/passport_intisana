...
import 'listado_preceptor_citas_model.dart';
export 'listado_preceptor_citas_model.dart';

class ListadoPreceptorCitasWidget extends StatefulWidget {
  const ListadoPreceptorCitasWidget({super.key});

  @override
  State<ListadoPreceptorCitasWidget> createState() =>
      _ListadoPreceptorCitasWidgetState();
}

class _ListadoPreceptorCitasWidgetState
    extends State<ListadoPreceptorCitasWidget> with TickerProviderStateMixin {
  late ListadoPreceptorCitasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListadoPreceptorCitasModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'listadoPreceptorCitas'});
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'LISTADO_PRECEPTOR_CITAS_Container_to66d9');
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'LISTADO_PRECEPTOR_CITAS_btn-filter_ON_TA');
                                  logFirebaseEvent(
                                      ...
                                      return Builder(
                                        builder: (context) {
                                          final students = IntisanaVIIGroup
                                                  .meetingsbyStatusCall
                                                  .student(
                                                    listViewMeetingsbyStatusResponse
                                                        .jsonBody,
                                                  )
                                                  ?.map((e) => e)
                                                  .toList()
                                          ...
                                          return RefreshIndicator(
                                            ...
                                            onRefresh: () async {
                                              logFirebaseEvent(
                                                  'LISTADO_PRECEPTOR_CITAS_ListView_b5mz02k');
                                              logFirebaseEvent(
                                              ...
                                              itemBuilder:
                                                ...
                                                return Padding(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'LISTADO_PRECEPTOR_CITAS_projectCard_ON_T');
                                                      logFirebaseEvent(
                                                                      ...
                                                                      children: [
                                                                        if (getJsonField(
                                                                          ...
                                                                          FFButtonWidget(
                                                                            onPressed:
                                                                                () async {
                                                                              logFirebaseEvent('LISTADO_PRECEPTOR_CITAS_COMPLETADO_BTN_O');
