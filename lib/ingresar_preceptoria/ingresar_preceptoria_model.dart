...
import 'ingresar_preceptoria_widget.dart' show IngresarPreceptoriaWidget;
...
class IngresarPreceptoriaModel
    extends FlutterFlowModel<IngresarPreceptoriaWidget> {
  ...
  String? _pinFieldTextControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return 'Campo requerido';
    }
  ...
  // Stores action output result for [Backend Call - API (MentorshipsPost)] action in Button widget.
  ApiCallResponse? apiResulMentorship;
  ...
  void initState(BuildContext context) {
    ...
    pinFieldTextControllerValidator = _pinFieldTextControllerValidator;
  }
